...
type QaUserSeed = {
  key: "patient" | "psychologist" | "practice_manager" | "admin";
...
async function ensureRoleProfile(seed: QaUserSeed): Promise<void> {
...
async function upsertSeed(seed: QaUserSeed): Promise<void> {
